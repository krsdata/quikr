...
<div class="col-md-10">
     ...
     <div class="form-group{{ $errors->first('product_title', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Product Name <span class="error">*</span></label>
    ...
    <div class="form-group{{ $errors->first('product_category', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label">Product category <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::select('product_category',$cat, null,['class' => 'form-control form-cascade-control input-small'])  !!}
     ...
     <div class="form-group{{ $errors->first('image', ' has-error') }}">
        ...
        <div class="col-lg-8 col-md-8">  
             ...
             @if(!empty($product->photo))
                 <img src="{!! Url::to('public/uploads/products/'.$product->photo) !!}" width="100px">
